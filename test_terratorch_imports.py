...
def test_terratorch_imports():
    ...
    try:
        ...
        # Test if build_model is available
        hasattr(terratorch.models, "build_model")
    ...
    try:
        ...
        # Test if BACKBONE_REGISTRY is available
        hasattr(terratorch.models.backbones, "BACKBONE_REGISTRY")
